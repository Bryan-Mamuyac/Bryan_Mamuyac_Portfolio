...
export const skills = {
  fullstack: [
    { name: "ASP.NET Core MVC 8", level: 90, icon: "⚡" },
    { name: "SQL Server / Dapper", level: 88, icon: "🗄️" },
    { name: "HTML / CSS / JavaScript", level: 92, icon: "🌐" },
    { name: "PHP / Laravel", level: 75, icon: "🐘" },
    { name: "MySQL", level: 82, icon: "🐬" },
    { name: "SignalR (WebSockets)", level: 78, icon: "⚡" },
    { name: "React", level: 70, icon: "⚛️" },
  ],
  dataAnalytics: [
    { name: "Power BI", level: 88, icon: "📊" },
    { name: "Tableau", level: 55, icon: "📈", tag: "Learning" },
    { name: "Python (Pandas / NumPy)", level: 82, icon: "🐍" },
    { name: "SQL (Querying & Reporting)", level: 88, icon: "📋" },
    { name: "Excel / SSIS", level: 78, icon: "📑" },
    { name: "Data Visualization", level: 85, icon: "🎨" },
  ],
  other: [
    { name: "IoT / Arduino", level: 72, icon: "🤖" },
    { name: "Cisco Networking", level: 70, icon: "🌐" },
    { name: "Git / GitHub", level: 80, icon: "📦" },
    { name: "Adobe Premiere Pro", level: 65, icon: "🎬" },
