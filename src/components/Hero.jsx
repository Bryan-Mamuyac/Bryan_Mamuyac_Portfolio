...
const Hero = () => {
  ...
  const handleDownloadResume = () => {
    ...
    link.download = 'Mamuyac_Bryan_Resume.pdf';
    link.click();
  };
    ...
    <section id="hero" style={{
      ...
      <div style={{ maxWidth: '960px', width: '100%', textAlign: 'center', position: 'relative', zIndex: 2 }}>
        ...
        <div style={{
          ...
          <span style={{ width: '8px', height: '8px', borderRadius: '50%', background: '#68d391', boxShadow: '0 0 8px #68d391' }} />
      ...
      <div style={{
        ...
        <span style={{ fontFamily: 'var(--font-mono)', fontSize: '0.62rem', color: 'var(--text-muted)', letterSpacing: '0.25em' }}>SCROLL</span>
