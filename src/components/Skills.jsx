...
const ICONS = {
  ...
  // ── Currently Learning ──
  'TypeScript': { color: '#3178c6', svg: <svg viewBox="0 0 128 128" width="44" height="44"><rect width="128" height="128" rx="10" fill="#3178C6"/><text x="50%" y="65%" textAnchor="middle" fill="#fff" fontSize="58" fontWeight="900" dy=".05em" fontFamily="Arial Black">TS</text></svg> },
  'Node.js':    { color: '#339933', svg: <svg viewBox="0 0 128 128" width="44" height="44"><path fill="#339933" d="M64 5L8 37v54l56 32 56-32V37L64 5zm0 12l44 25v9L64 26 20 51v-9L64 17zm0 86L20 79V61l44 25 44-25v18L64 103z"/></svg> },
  'Vue.js':     { color: '#42b883', svg: <svg viewBox="0 0 128 128" width="44" height="44"><rect width="128" height="128" rx="10" fill="#35495e"/><path fill="#42B883" d="M64 24L40 64l24 40 24-40z"/><path fill="#35495e" d="M64 24L52 44l12 20 12-20z"/><path fill="#41b883" d="M40 64L16 24h16l32 56 32-56h16L64 104z"/></svg> },
  'Next.js':    { color: '#ffffff', svg: <svg viewBox="0 0 128 128" width="44" height="44"><rect width="128" height="128" rx="10" fill="#000"/><path fill="#fff" d="M64 14C37 14 15 36 15 63c0 22 14 40 34 47 2.5.5 3.4-1.1 3.4-2.4v-8.5c-14 3-17-6.8-17-6.8-2.3-5.8-5.6-7.3-5.6-7.3-4.6-3.1.3-3.1.3-3.1 5.1.4 7.8 5.2 7.8 5.2 4.5 7.8 11.9 5.5 14.8 4.2.5-3.3 1.8-5.5 3.2-6.8-11.3-1.3-23.2-5.7-23.2-25.2 0-5.6 2-10.1 5.2-13.7-.5-1.3-2.3-6.5.5-13.5 0 0 4.2-1.4 13.8 5.2a48 48 0 0125.2 0c9.6-6.6 13.8-5.2 13.8-5.2 2.8 7 1 12.2.5 13.5 3.2 3.6 5.2 8.1 5.2 13.7 0 19.6-11.9 23.9-23.3 25.2 1.8 1.6 3.5 4.7 3.5 9.5v14.1c0 1.4.9 2.9 3.5 2.4C99 103 113 85 113 63c0-27-22-49-49-49z"/></svg> },
  'Angular':    { color: '#dd0031', svg: <svg viewBox="0 0 128 128" width="44" height="44"><path fill="#DD0031" d="M64 4L8 24l8 72 48 28 48-28 8-72z"/><path fill="#C3002F" d="M64 4v124l48-28 8-72z"/><path fill="#fff" d="M64 18L34 92h11l6-15h26l6 15h11L64 18zm0 22l10 28H54l10-28z"/></svg> },
  'Java':       { color: '#f89820', svg: <svg viewBox="0 0 128 128" width="44" height="44"><path fill="#f89820" d="M47 94s-4 2 3 3c8 1 12 1 21-1 0 0 2 1 5 2-18 8-42-1-29-4zm-3-13s-4 3 4 4c9 1 17 1 24-1 0 0 2 1 4 2-21 6-44 1-32-5z"/><path fill="#ea2d2e" d="M64 44s8 8-8 20c-13 10-3 16 0 23-8-7-13-13-9-19 5-9 19-13 17-24z"/><path fill="#f89820" d="M82 98s3 2-3 4c-10 3-42 4-51 0-3-1 3-3 5-4 1 0 2 0 3 1-4 2-13 5 24 5s30-4 22-6zm3-10s3 2-2 4c-7 2-34 3-42 1-3 0 1-2 3-3 1 0 2 0 3 1-3 1-10 3 18 3s26-4 20-6z"/><path fill="#5382a1" d="M54 6s11 11-10 28C28 47 42 57 44 66 35 57 27 53 31 45 37 34 57 29 54 6zm10 114s3 1-3 2c-9 2-34 1-29-2 2-1 3-1 5-1-7 4 27 5 27 1z"/></svg> },
...
// ─── Row data ─────────────────────────────────────────────────────────────────
const FULLSTACK_ROW = ['ASP.NET','C#','SQL Server','JavaScript','HTML5','CSS3','PHP','MySQL','Laravel','Git','React','Python','TypeScript','Node.js','Vue.js','Next.js','Angular','Java'];
...
const SKILL_ICONS = {
  ...
  typescript: <svg viewBox="0 0 24 24" fill="none" stroke="#3178c6" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="3"/><path d="M7 15v-4h10M14 11v7"/></svg>,
  nodejs:     <svg viewBox="0 0 24 24" fill="none" stroke="#339933" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2L2 7v5c0 5.5 4.1 10.7 10 12 5.9-1.3 10-6.5 10-12V7L12 2z"/></svg>,
  vue:        <svg viewBox="0 0 24 24" fill="none" stroke="#42b883" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2L2 4l10 18L22 4l-10-2z"/><path d="M12 2L8 8l4 8 4-8-4-6z"/></svg>,
  nextjs:     <svg viewBox="0 0 24 24" fill="none" stroke="var(--text-primary)" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M9 8l7 8M16 8v8"/></svg>,
  angular:    <svg viewBox="0 0 24 24" fill="none" stroke="#dd0031" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2L3 6l1.5 13L12 22l7.5-3L21 6z"/><path d="M9 16l2-4 1-2 1 2 2 4M10 14h4"/></svg>,
  java:       <svg viewBox="0 0 24 24" fill="none" stroke="#f89820" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"><path d="M8 18s-2 1 1 2c4 1 6 1 10 0 0 0 1 1 2 1-7 3-16 0-13-3zM7 15s-2 1 2 2c4 1 7 0 10-1 0 0 1 1 2 1-8 2-17 0-14-2z"/><path d="M12 6s4 4-3 9c-5 4-1 7 0 10-3-3-5-6-4-8 2-4 8-5 7-11zM18 21s1 1-1 2c-4 1-17 2-21 0-1 0 1-1 2-2 0 0 1 0 1 1-2 1 22 2 19-1z"/></svg>,
};
    ...
    <section id="skills" className="section" style={{ background: 'rgba(0,0,0,0.08)' }}>
      <div className="container" ref={ref}>
        ...
        <div className="glass" style={{
          ...
          <MarqueeRow items={FULLSTACK_ROW} reverse={false} speed={52} />
        </div>
